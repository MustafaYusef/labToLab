...
class LabInfoController extends GetxController {
  ...
  var labInfoListTemp = <Information>[].obs;
  ...
  Future<void> searchItems(String query) async {
    List<Information> temp1 = <Information>[];
  ...
  Future<void> getLabInfo() async {
    ...
    try {
      ...
      labInfoListTemp.assignAll(prof.informations);
